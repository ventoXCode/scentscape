...
export type FragranceDataFamilyEnum =
  | 'Fresh'
  | 'Floral'
  | 'Amber'
  | 'Woody';

export type FragranceDataConcentrationEnum =
  | 'EDC'
  | 'EDT'
  | 'EDP'
  | 'Parfum'
...
export type FragranceDataGenderEnum =
  | 'Masculine'
  | 'Feminine'
  | 'Unisex';

export type FragranceData = {
  __typename?: 'FragranceData';
  id: Scalars['ID']['output'];
  product_id: Scalars['String']['output'];
  top_notes: Scalars['JSON']['output'];
  heart_notes: Scalars['JSON']['output'];
  base_notes: Scalars['JSON']['output'];
  accords: Scalars['JSON']['output'];
  family: FragranceDataFamilyEnum;
  sub_family: Maybe<Scalars['String']['output']>;
  concentration: FragranceDataConcentrationEnum;
  longevity: Maybe<Scalars['Float']['output']>;
  sillage: Maybe<Scalars['Float']['output']>;
  projection: Maybe<Scalars['Float']['output']>;
  gender: FragranceDataGenderEnum;
  season: Scalars['JSON']['output'];
  occasion: Scalars['JSON']['output'];
...
export type QuizSession = {
  ...
  family_affinities: Scalars['JSON']['output'];
  accord_affinities: Scalars['JSON']['output'];
  intensity: Maybe<Scalars['String']['output']>;
  occasions: Scalars['JSON']['output'];
  experience: Maybe<Scalars['String']['output']>;
  archetype_id: Scalars['String']['output'];
