          ...
          <div className="space-y-4">
            {results.map((result, index) => (
              <Link
                ...
                className="group flex gap-4 p-4 rounded-xl border border-border-default bg-surface-elevated hover:border-border-strong hover:shadow-card-hover transition-all duration-200"
              >
                {/* Rank badge */}
